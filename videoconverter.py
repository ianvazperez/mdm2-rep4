...
video_clip.write_videofile("cropped-video(203).mp4", fps=24, remove_temp=True, codec="libx264", audio_codec="aac")
...
final_clip.write_videofile("cropped-video-final(203).mp4", fps=24, remove_temp=True, codec="libx264", audio_codec="aac")